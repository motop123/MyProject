...
insert into Награды(ID_Награды,Наименование)
values (1,N'Награда за хорошее выполнение команд')
insert into Награды(ID_Награды,Наименование)
values (2,N'Награда за лучший номер')
insert into Награды(ID_Награды,Наименование)
values (3,N'Награда за быстрое преодоление препятствий')
insert into Награды(ID_Награды,Наименование)
values (4,N'Лучший щенок породы')
insert into Награды(ID_Награды,Наименование)
values (5,N'Лучший кот породы')
insert into Награды(ID_Награды,Наименование)
values (6,N'Лучший юниор')
insert into Награды(ID_Награды,Наименование)
values (7,N'Лучший юниор породы')
insert into Награды(ID_Награды,Наименование)
values (8,N'Победитель класса')
insert into Награды(ID_Награды,Наименование)
values (9,N'Лучший ветеран')
insert into Награды(ID_Награды,Наименование)
values (10,N'Лучший ветеран породы')
insert into Награды(ID_Награды,Наименование)
values (11,N'Лучшая сука породы')
insert into Награды(ID_Награды,Наименование)
values (12,N'Лучший кобель породы')
insert into Награды(ID_Награды,Наименование)
values (13,N'Лучший представитель породы')
insert into Награды(ID_Награды,Наименование)
values (14,N'Лучший в группе')
insert into Награды(ID_Награды,Наименование)
values (15,N'Лучшая собака выставки')
insert into Награды(ID_Награды,Наименование)
values (16,N'Лучшая кошка выставки')
insert into Награды(ID_Награды,Наименование)
values (17,N'Награда за красоту  породы')
insert into Награды(ID_Награды,Наименование)
values (18,N'Награда за милату породы')
insert into Награды(ID_Награды,Наименование)
values (19,N'Награда за милату котят')
insert into Награды(ID_Награды,Наименование)
values (20,N'Награда за милату щенят')
...
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (1,N'Анти-Эхинококк',N'Россия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (2,N'ЭнцеВир',N'Россия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (3,N'Анти-грипп',N'Россия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (4,N'Nobivac Rabies',N'Голландия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (5,N'Nobivac L',N'Голландия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (6,N'Nobivac DH',N'Голландия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (7,N'Мультифел-4',N'Россия')
insert into Прививка(ID_прив,Название_прививки,Страна_производитель)
values (8,N'Nobivac Puppy DP',N'Голландия')
