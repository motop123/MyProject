...
<div id="overlay"></div>
        ...
        <p style="text-align: center;font-size: 21px;background-color: #1A1C1E;color: white;">ГРАФИК УБОРКИ</p>
			<table border='1' width='1000'>
<tbody>
<tr>
<td style="font-weight: bold;">Число</td>
<td style="font-weight: bold;">ФИО рабочего</td>
...
$result=mysql_query('SELECT * FROM `uborka`');
