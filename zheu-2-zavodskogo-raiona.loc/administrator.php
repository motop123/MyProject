...
<head>
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="css/styleTableAdm.css">
...
$result=mysql_query('SELECT * FROM `orderfeedback`');
...
?>
  ...
  <!-------------------Table checked------------------->
  <form action="TableDataBase.php">
        <p style="text-align: center;font-size: 21px;background-color: #1A1C1E;color: white;">ВЫПОЛНЕНЫЕ ЗАЯВКИ</p>
			<table border='1' width='1000'>
<tbody>
<tr>
<td>ID</td>
...
$result=mysql_query("SELECT * FROM `orderfeedback` where `check` = '1'");
